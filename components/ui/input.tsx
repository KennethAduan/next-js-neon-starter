  ...
  return (
    <InputPrimitive
      ...
      className={cn(
        ...
        variant === "default" && "rounded-lg px-2.5",
        variant === "md" && "rounded-md px-2.5",
        variant === "join" && "rounded-none px-1.5",
        variant === "affix" && "rounded-lg pr-8 pl-2.5",
        className
      )}
      {...props}
    />
